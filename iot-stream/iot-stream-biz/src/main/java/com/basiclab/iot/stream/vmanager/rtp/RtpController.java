package com.basiclab.iot.stream.vmanager.rtp;
...
public class RtpController {
    ...
    public OtherRtpSendInfo openRtpServer(Boolean isSend, @RequestParam(required = false)String ssrc, String callId, String stream, Integer tcpMode, String callBack) {
        ...
        String receiveKey = VideoManagerConstants.LF_OTHER_RECEIVE_RTP_INFO + userSetting.getServerId() + "_" + callId + "_"  + stream;
        ...
        String key = VideoManagerConstants.LF_OTHER_SEND_RTP_INFO + userSetting.getServerId() + "_"  + callId;
    ...
    public void closeRtpServer(String stream) {
        ...
        String receiveKey = VideoManagerConstants.LF_OTHER_RECEIVE_RTP_INFO + userSetting.getServerId() + "_*_"  + stream;
