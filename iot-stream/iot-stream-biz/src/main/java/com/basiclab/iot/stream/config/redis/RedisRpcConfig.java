...
public class RedisRpcConfig implements MessageListener {
    ...
    public final static String REDIS_REQUEST_CHANNEL_KEY = "LF_REDIS_REQUEST_CHANNEL_KEY";
...
//        List<Class<?>> classList = ClassUtil.getClassList("com.basiclab.iot.stream.service.redisMsg.control", RedisRpcController.class);
