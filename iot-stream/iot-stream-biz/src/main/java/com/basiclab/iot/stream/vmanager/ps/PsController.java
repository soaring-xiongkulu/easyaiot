package com.basiclab.iot.stream.vmanager.ps;
...
public class PsController {
    ...
    public OtherPsSendInfo openRtpServer(Boolean isSend, @RequestParam(required = false)String ssrc, String callId, String stream, Integer tcpMode, String callBack) {
        ...
        String receiveKey = VideoManagerConstants.LF_OTHER_RECEIVE_PS_INFO + userSetting.getServerId() + "_" + callId + "_"  + stream;
        ...
        if (isSend != null && isSend) {
            String key = VideoManagerConstants.LF_OTHER_SEND_PS_INFO + userSetting.getServerId() + "_"  + callId;
            // 预创建发流信息
    ...
    public void closeRtpServer(String stream) {
        ...
        String receiveKey = VideoManagerConstants.LF_OTHER_RECEIVE_PS_INFO + userSetting.getServerId() + "_*_"  + stream;
