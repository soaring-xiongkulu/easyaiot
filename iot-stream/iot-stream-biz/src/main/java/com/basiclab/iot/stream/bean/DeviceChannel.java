...
import com.basiclab.iot.stream.utils.MessageElementForCatalog;
...
@KeySequence("wvp_device_channel_seq") // 用于 Oracle、PostgreSQL、Kingbase、DB2、H2 数据库的主键自增。如果是 MySQL 等数据库，可不写。
@Data
