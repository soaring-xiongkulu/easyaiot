...
import com.basiclab.iot.stream.transmit.event.request.impl.message.notify.cmd.AlarmNotifyMessageHandler;
...
//        properties.setProperty("javax.sip.IP_ADDRESS", ip);
        ...
        if (sipLog) {
            properties.setProperty("gov.nist.javax.sip.STACK_LOGGER", "com.basiclab.iot.stream.conf.StackLoggerImpl");
            properties.setProperty("gov.nist.javax.sip.SERVER_LOGGER", "com.basiclab.iot.stream.conf.ServerLoggerImpl");
