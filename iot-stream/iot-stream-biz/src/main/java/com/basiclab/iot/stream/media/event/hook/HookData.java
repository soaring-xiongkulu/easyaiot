package com.basiclab.iot.stream.media.event.hook;

import com.basiclab.iot.stream.media.bean.MediaInfo;
import com.basiclab.iot.stream.media.bean.MediaServer;
import com.basiclab.iot.stream.media.bean.RecordInfo;
import com.basiclab.iot.stream.media.event.media.MediaArrivalEvent;
import com.basiclab.iot.stream.media.event.media.MediaEvent;
import com.basiclab.iot.stream.media.event.media.MediaPublishEvent;
