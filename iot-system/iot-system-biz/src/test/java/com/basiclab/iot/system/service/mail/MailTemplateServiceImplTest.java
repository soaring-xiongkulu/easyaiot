...
import com.basiclab.iot.system.controller.admin.mail.vo.template.MailTemplateSaveReqVO;
import com.basiclab.iot.system.dal.dataobject.mail.MailTemplateDO;
import com.basiclab.iot.system.dal.mysql.mail.MailTemplateMapper;
...
public class MailTemplateServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetMailTemplatePage() {
        ...
        // 测试 name 不匹配
        mailTemplateMapper.insert(cloneIgnoreId(dbMailTemplate, o -> o.setName("BasicLab")));
        // 测试 code 不匹配
