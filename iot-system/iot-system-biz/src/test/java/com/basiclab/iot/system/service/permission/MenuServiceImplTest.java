package com.basiclab.iot.system.service.permission;
...
import com.basiclab.iot.system.controller.admin.permission.vo.menu.MenuSaveVO;
import com.basiclab.iot.system.dal.dataobject.permission.MenuDO;
import com.basiclab.iot.system.dal.mysql.permission.MenuMapper;
import com.basiclab.iot.system.enums.permission.MenuTypeEnum;
...
public class MenuServiceImplTest extends BaseDbUnitTest {
    ...
    private MenuDO createParentAndSonMenu() {
        // 构造父子菜单
        MenuDO parentMenuDO = buildMenuDO(MenuTypeEnum.MENU, "parent", MenuDO.ID_ROOT);
