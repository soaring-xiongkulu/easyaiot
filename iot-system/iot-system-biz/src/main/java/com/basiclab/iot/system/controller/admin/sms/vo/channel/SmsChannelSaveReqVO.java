...
public class SmsChannelSaveReqVO {
    ...
    @Schema(description = "短信签名", requiredMode = Schema.RequiredMode.REQUIRED, example = "DVM")
    ...
    @Schema(description = "短信发送回调 URL", example = "https://gitee.com/DEEP-VISION-MACHINE/LF-AI-STREAM")
