...
public class CollectionUtils {
    ...
    public static boolean containsAny(Collection<?> source, Collection<?> candeviceIdentificationates) {
        return org.springframework.util.CollectionUtils.containsAny(source, candeviceIdentificationates);
    }
