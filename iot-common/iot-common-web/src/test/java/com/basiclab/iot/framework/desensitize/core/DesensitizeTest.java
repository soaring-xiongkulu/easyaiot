package com.basiclab.iot.common.desensitize.core;
...
public class DesensitizeTest {
    ...
    public void test() {
        ...
        desensitizeDemo.setNickname("LF");
        ...
        desensitizeDemo.setRegex("你好，我是LF");
        desensitizeDemo.setAddress("北京市海淀区上地十街10号");
        desensitizeDemo.setOrigin("LF");
    ...
    public static class DesensitizeDemo {
        ...
        @RegexDesensitize(regex = "LF", replacer = "*")
