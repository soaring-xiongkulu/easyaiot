...
import com.basiclab.iot.common.redis.config.YudaoRedisMQConsumerAutoConfiguration;
import com.basiclab.iot.common.redis.core.RedisMQTemplate;
import com.basiclab.iot.common.core.handler.JsonWebSocketMessageHandler;
import com.basiclab.iot.common.core.listener.WebSocketMessageListener;
import com.basiclab.iot.common.core.security.LoginUserHandshakeInterceptor;
import com.basiclab.iot.common.core.sender.kafka.KafkaWebSocketMessageConsumer;
import com.basiclab.iot.common.core.sender.kafka.KafkaWebSocketMessageSender;
import com.basiclab.iot.common.core.sender.local.LocalWebSocketMessageSender;
import com.basiclab.iot.common.core.sender.rabbitmq.RabbitMQWebSocketMessageConsumer;
import com.basiclab.iot.common.core.sender.rabbitmq.RabbitMQWebSocketMessageSender;
import com.basiclab.iot.common.core.sender.redis.RedisWebSocketMessageConsumer;
import com.basiclab.iot.common.core.sender.redis.RedisWebSocketMessageSender;
import com.basiclab.iot.common.core.sender.rocketmq.RocketMQWebSocketMessageConsumer;
import com.basiclab.iot.common.core.sender.rocketmq.RocketMQWebSocketMessageSender;
import com.basiclab.iot.common.core.session.WebSocketSessionHandlerDecorator;
import com.basiclab.iot.common.core.session.WebSocketSessionManager;
import com.basiclab.iot.common.core.session.WebSocketSessionManagerImpl;
...
@ConditionalOnProperty(prefix = "iot.websocket", value = "enable", matchIfMissing = true) // 允许使用 iot.websocket.enable=false 禁用 websocket
...
public class YudaoWebSocketAutoConfiguration {
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "iot.websocket", name = "sender-type", havingValue = "local", matchIfMissing = true)
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "iot.websocket", name = "sender-type", havingValue = "redis", matchIfMissing = true)
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "iot.websocket", name = "sender-type", havingValue = "rocketmq", matchIfMissing = true)
    public class RocketMQWebSocketMessageSenderConfiguration {
        ...
        public RocketMQWebSocketMessageSender rocketMQWebSocketMessageSender(
                ...
                @Value("${iot.websocket.sender-rocketmq.topic}") String topic) {
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "iot.websocket", name = "sender-type", havingValue = "rabbitmq", matchIfMissing = true)
    public class RabbitMQWebSocketMessageSenderConfiguration {
         ...
         */
        @Bean
        public TopicExchange websocketTopicExchange(@Value("${iot.websocket.sender-rabbitmq.exchange}") String exchange) {
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "iot.websocket", name = "sender-type", havingValue = "kafka", matchIfMissing = true)
    public class KafkaWebSocketMessageSenderConfiguration {
        ...
        public KafkaWebSocketMessageSender kafkaWebSocketMessageSender(
                ...
                @Value("${iot.websocket.sender-kafka.topic}") String topic) {
