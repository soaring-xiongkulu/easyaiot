package com.basiclab.iot.gateway.filter.grey;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.util.StrUtil;
import com.basiclab.iot.common.utils.collection.CollectionUtils;
import com.basiclab.iot.gateway.util.EnvUtils;
...
public class GrayLoadBalancer implements ReactorServiceInstanceLoadBalancer {
    ...
    private Response<ServiceInstance> getInstanceResponse(List<ServiceInstance> instances, HttpHeaders headers) {
        ...
        // 随机 + 权重获取实例列表 TODO BasicLab：目前直接使用 Nacos 提供的方法，如果替换注册中心，需要重新失败该方法
