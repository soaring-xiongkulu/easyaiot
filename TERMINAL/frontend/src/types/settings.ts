...
export interface TerminalSettings {
  ...
  // OS default under ~/Documents/Terminal/logs.
...
export const DEFAULT_SETTINGS: AppSettings = {
  // Bright-by-default: fresh installs start on the light theme to match the
  // platform shell; dark / deep-blue / system remain selectable in settings.
  // Keep main.go windowBackgroundColour's empty-theme fallback in sync.
  theme: 'light',
  language: 'system',
...
export const TERMINAL_THEMES: TerminalThemeEntry[] = [
  { label: 'Terminal Dark', value: 'terminal-dark', type: 'dark' },
  { label: 'Terminal Light', value: 'terminal-light', type: 'light' },
