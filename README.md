...
<ul style="font-size: 14px; line-height: 1.8; color: #444; margin: 10px 0;">
  ...
  <li><strong>Unified management entry</strong>: root-level <code>mobile.sh</code> covers all three ends—<code>status</code> (version consistency + toolchain readiness + existing artifacts), <code>build android|ios|harmonyos|all</code>, <code>bump</code>, <code>artifacts</code>, and <code>clean</code>—daily operations never need to enter each module separately</li>
...
<td style="padding: 15px; border: 1px solid #e0e0e0; line-height: 1.8; color: #444;">
  <ul style="margin: 5px 0; padding-left: 20px;">
    ...
    <li><strong>Unified management</strong>: root-level <code>mobile.sh</code> for status / build / bump / artifacts / clean; <code>bump</code> updates all five version fields at once and packaging refuses mismatched versions</li>
  </ul>
</td>
</tr>
<tr>
