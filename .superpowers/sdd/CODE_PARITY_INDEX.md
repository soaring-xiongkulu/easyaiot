...
| CP-11 Deep gap cleanup | W6 | **PASS** | [cp-11-deep-parity-brief.md](./briefs/cp-11-deep-parity-brief.md) | [cp-11-report.md](./briefs/cp-11-report.md) | `logs/cp-11-*.json` | *(see report)* |
