...
1. Промежуточное ПО (PostgreSQL → Redis → Nacos → RustFS → Kafka → TDengine → SRS)
...
| RustFS API | 9000 | HTTP | API объектного хранилища |
| RustFS Console | 9001 | HTTP | Консоль объектного хранилища |
