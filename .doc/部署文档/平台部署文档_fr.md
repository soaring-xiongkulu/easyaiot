...
- OS : **Ubuntu 24.04+** (26.04 recommandé) ; également **CentOS/RHEL**, **openEuler (欧拉) 24.x**, ARM, Kylin (麒麟)
...
| Élément | Exigence |
|------|-------------|
| OS | Ubuntu 24.04+ (26.04 recommandé) ; également macOS, Windows, CentOS/RHEL, openEuler (欧拉) 24.x, ARM, Kylin (麒麟) |
