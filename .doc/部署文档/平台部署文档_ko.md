...
- OS: **Ubuntu 24.04+** (26.04 권장); **CentOS/RHEL**, **openEuler (欧拉) 24.x**, ARM, Kylin도 지원
...
| 항목 | 요구사항 |
|------|----------|
| OS | Ubuntu 24.04+ (26.04 권장); macOS, Windows, CentOS/RHEL, openEuler (欧拉) 24.x, ARM, Kylin도 지원 |
