...
|----------|-------------|
| OS | Ubuntu 24.04+ (26.04 recommended); CentOS/RHEL, openEuler (欧拉) 24.x, Kylin (麒麟), ARM64 also supported |
...
# openEuler 24.x (replace stock docker-engine, fix repo releasever, install Docker CE)
