...
| EX-SCENARIO-POSE | Scenario pose library (`/video/scenario-pose/*`) | **resolved by FR-W3-POSE** (2026-08-10): Java `ScenarioPoseController` + `ScenarioPoseLibraryService`; route_inventory `/video/scenario-pose` diff=0 | orchestrator, 2026-08-10 |
