...
| 0.4 | Phase 0 薄烟雾 | `python tools/video_java/certify.py --phase 0` | `gates/PHASE_0_GATE.md` PASS | ✅ local-only evidence — FR-B27 复跑 PASS 5/5（mini-safe 恢复后）；`logs/fr-b27-phase0.log` |
