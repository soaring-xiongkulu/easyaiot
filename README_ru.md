...
<ul style="font-size: 14px; line-height: 1.8; color: #444; margin: 10px 0;">
  ...
  <li><strong>Связанная область обнаружения + Период обороны + Событие тревоги, Тройная связанная тревога</strong>: Поддерживает интеллектуальный механизм связи между областями обнаружения, периодами обороны и событиями тревоги. Когда обнаруженное событие одновременно соответствует указанному диапазону области обнаружения, находится в периоде обороны и соответствует типу события тревоги, система автоматически активирует связанную тревогу, обеспечивая точные пространственно-временные условные тревоги, эффективно снижая ложные срабатывания и повышая точность и практичность тревог.</li>
...
<strong>⚠️ Пояснение по развертыванию на Windows</strong>: В настоящее время однокнопочный скрипт развертывания для Windows все еще имеет проблемы, и в ближайшее время эти вопросы решаться не будут. Пользователям Windows рекомендуется обратиться к документации по развертыванию для ручной установки или использовать среду Linux/Mac для развертывания.
</p>
...
<p style="font-size: 15px; line-height: 1.8; color: #333; margin: 15px 0;">
翱翔的雄库鲁/easyaiot использует лицензию с открытым исходным кодом <a href="https://gitee.com/soaring-xiongkulu/easyaiot/blob/main/LICENSE" style="color: #3498db; text-decoration: none; font-weight: 600;">APACHE LICENSE 2.0</a>. При использовании необходимо обратить внимание на следующие моменты:
</p>

<ol style="font-size: 14px; line-height: 1.8; color: #444; margin: 15px 0; padding-left: 25px;">
  <li>Нельзя изменять исходные комментарии и указания авторства в коде продукта;</li>
  <li>Нельзя использовать в действиях, наносящих вред национальной безопасности, чести и интересам, а также для любых незаконных целей;</li>
</ol>
