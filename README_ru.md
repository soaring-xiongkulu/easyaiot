...
📦 <strong>Скачать установщики</strong>: Пакеты для Ubuntu / Debian, CentOS / RHEL, Windows, macOS и ARM / <strong>Kylin (麒麟)/openEuler (欧拉)</strong> — на <a href="https://gitee.com/volara/easyaiot/releases" style="color: #3498db; text-decoration: none; font-weight: 600;">Gitee Releases</a>.
</p>
...
<td style="padding: 15px; border: 1px solid #e0e0e0; line-height: 1.8; color: #444;">
  <ul style="margin: 5px 0; padding-left: 20px;">
    <li><strong>Мультиплатформенные артефакты</strong>: Собирать PANEL и смежные возможности в пакеты/бинари для Ubuntu / Debian, CentOS / RHEL, Windows, macOS и ARM / <strong>Kylin (麒麟)/openEuler (欧拉)</strong> — клиент ставит без компиляции с исходников на площадке</li>
...
<ul style="font-size: 14px; line-height: 1.8; margin: 10px 0; padding-left: 20px;">
  ...
  <li>Поддержка серверных дистрибутивов: Ubuntu, CentOS/RHEL, <strong>Kylin (麒麟)/openEuler (欧拉)</strong></li>
</ul>
</div>
...
- [Документация по развертыванию платформы](.doc/部署文档/平台部署文档_ru.md) — Linux (Ubuntu / CentOS / ARM / **Kylin (麒麟)/openEuler (欧拉)**) / Mac / Windows
