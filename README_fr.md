...
<td style="padding: 15px; border: 1px solid #e0e0e0; line-height: 1.8; color: #444;">
  <ul style="margin: 5px 0; padding-left: 20px;">
    ...
    <li><strong>Gestion unifiée</strong> : <code>mobile.sh</code> à la racine pour status / build / bump / artifacts / clean ; <code>bump</code> aligne les cinq champs de version d'un coup et le packaging refuse les versions incohérentes</li>
  </ul>
</td>
</tr>
<tr>
