...
<ul style="font-size: 14px; line-height: 1.8; color: #444; margin: 10px 0;">
  ...
  <li><strong>Région de détection associée + Période de défense + Alerte d'événement, Alerte triple liaison</strong> : Prend en charge un mécanisme de liaison intelligente entre les régions de détection, les périodes de défense et les alertes d'événements. Lorsqu'un événement détecté satisfait simultanément la plage de région de détection spécifiée, se trouve dans la période de défense et correspond au type d'alerte d'événement, le système déclenchera automatiquement une alerte liée, réalisant des alertes conditionnelles spatio-temporelles précises, réduisant efficacement les faux positifs et améliorant la précision et la praticité des alertes.</li>
