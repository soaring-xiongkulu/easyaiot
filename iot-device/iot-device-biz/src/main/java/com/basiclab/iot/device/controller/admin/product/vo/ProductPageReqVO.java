...
public class ProductPageReqVO extends PageParam {
    ...
    @Schema(description = "产品唯一标识", example = "2009")
    private String pid;

    @Schema(description = "厂商名称 :支持中文、英文大小写、数字、下划线和中划线", example = "王五")
    ...
    @Schema(description = "设备接入平台的协议类型，默认为MQTT无需修改。", example = "2")
    ...
    @Schema(description = "厂商Code:支持英文大小写，数字，下划线和中划线")
