...
@Schema(description = "管理后台 - 产品模型设备下发服务命令属性分页 Request VO")
@Data
@EqualsAndHashCode(callSuper = true)
@ToString(callSuper = true)
public class ProductCommandsRequestsPageReqVO extends PageParam {

    @Schema(description = "服务ID", example = "7796")
    private Long serviceId;

    @Schema(description = "命令ID", example = "28070")
    private Long commandsId;

    @Schema(description = "指示数据类型。取值范围：string、int、decimal	", example = "1")
