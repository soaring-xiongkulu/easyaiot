package com.basiclab.iot.device.dal.dataobject.product_commands_requests;
 ...
 * @author BasicLab
 */
@TableName("product_commands_requests")
@KeySequence("product_commands_requests_seq") // 用于 Oracle、PostgreSQL、Kingbase、DB2、H2 数据库的主键自增。如果是 MySQL 等数据库，可不写。
@Data
...
@NoArgsConstructor
@AllArgsConstructor
public class ProductCommandsRequestsDO extends BaseDO {
