...
import com.basiclab.iot.common.mybatis.core.type.EncryptTypeHandler;
import com.basiclab.iot.common.mybatis.core.util.JdbcUtils;
...
import com.basiclab.iot.infra.dal.mysql.db.DataSourceConfigMapper;
...
public class DataSourceConfigServiceImplTest extends BaseDbUnitTest {
    ...
    public void testUpdateDataSourceConfig_notExists() {
        ...
        // 调用, 并断言异常
        assertServiceException(() -> dataSourceConfigService.updateDataSourceConfig(reqVO), ErrorCodeConstants.DATA_SOURCE_CONFIG_NOT_EXISTS);
    }
    ...
    public void testDeleteDataSourceConfig_notExists() {
        ...
        // 调用, 并断言异常
        assertServiceException(() -> dataSourceConfigService.deleteDataSourceConfig(id), ErrorCodeConstants.DATA_SOURCE_CONFIG_NOT_EXISTS);
    }
