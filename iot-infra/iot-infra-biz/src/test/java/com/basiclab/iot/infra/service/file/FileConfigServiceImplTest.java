...
import com.basiclab.iot.infra.dal.pgsql.file.FileConfigMapper;
...
import static com.basiclab.iot.common.core.util.RandomUtils.randomLongId;
import static com.basiclab.iot.common.core.util.RandomUtils.randomPojo;
...
public class FileConfigServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetFileConfigPage() {
        // mock 数据
        FileConfigDO dbFileConfig = randomFileConfigDO().setName("BasicLab源码")
