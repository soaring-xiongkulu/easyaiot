...
import com.basiclab.iot.infra.dal.mysql.file.FileConfigMapper;
...
import com.basiclab.iot.infra.framework.file.core.client.FileClientFactory;
...
import static com.basiclab.iot.common.test.core.util.RandomUtils.randomLongId;
import static com.basiclab.iot.common.test.core.util.RandomUtils.randomPojo;
...
public class FileConfigServiceImplTest extends BaseDbUnitTest {
    ...
    public void testUpdateFileConfig_notExists() {
        ...
        // 调用, 并断言异常
        assertServiceException(() -> fileConfigService.updateFileConfig(reqVO), ErrorCodeConstants.FILE_CONFIG_NOT_EXISTS);
    }
    ...
    public void testUpdateFileConfigMaster_notExists() {
        // 调用, 并断言异常
        assertServiceException(() -> fileConfigService.updateFileConfigMaster(randomLongId()), ErrorCodeConstants.FILE_CONFIG_NOT_EXISTS);
    }
    ...
    public void testDeleteFileConfig_notExists() {
        ...
        // 调用, 并断言异常
        assertServiceException(() -> fileConfigService.deleteFileConfig(id), ErrorCodeConstants.FILE_CONFIG_NOT_EXISTS);
    }
    ...
    public void testDeleteFileConfig_master() {
        ...
        // 调用, 并断言异常
        assertServiceException(() -> fileConfigService.deleteFileConfig(id), ErrorCodeConstants.FILE_CONFIG_DELETE_FAIL_MASTER);
    }

    @Test
    public void testGetFileConfigPage() {
        // mock 数据
        FileConfigDO dbFileConfig = randomFileConfigDO().setName("DVM")
