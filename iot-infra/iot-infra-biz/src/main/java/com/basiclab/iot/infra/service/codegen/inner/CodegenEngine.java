...
import com.basiclab.iot.common.apilog.core.annotation.ApiAccessLog;
import com.basiclab.iot.common.apilog.core.enums.OperateTypeEnum;
...
import com.basiclab.iot.common.utils.date.DateUtils;
...
import com.basiclab.iot.common.utils.string.StrUtils;
import com.basiclab.iot.common.excel.core.annotations.DictFormat;
import com.basiclab.iot.common.excel.core.convert.DictConvert;
import com.basiclab.iot.common.excel.core.util.ExcelUtils;
import com.basiclab.iot.common.mybatis.core.dataobject.BaseDO;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "iot-${table.moduleName}/" + // 顶级模块
                "iot-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "iot-${table.moduleName}/" + // 顶级模块
                "iot-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "iot-ui-${sceneEnum.basePackage}-vue2/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "iot-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
