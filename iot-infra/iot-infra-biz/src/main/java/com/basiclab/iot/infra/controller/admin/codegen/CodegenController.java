...
import com.basiclab.iot.infra.convert.codegen.CodegenConvert;
...
import com.basiclab.iot.infra.framework.file.core.utils.FileTypeUtils;
import com.basiclab.iot.infra.service.codegen.CodegenService;
...
public class CodegenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "comment", description = "描述，模糊匹配", example = "BasicLab")
    })
    ...
    public void downloadCodegen(@RequestParam("tableId") Long tableId,
        ...
        // 输出
        FileTypeUtils.writeAttachment(response, "codegen.zip", outputStream.toByteArray());
    }
