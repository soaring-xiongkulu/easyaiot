package com.basiclab.iot.infra.service.job;
...
import com.basiclab.iot.common.core.scheduler.SchedulerManager;
...
import com.basiclab.iot.infra.dal.pgsql.job.JobMapper;
import com.basiclab.iot.infra.enums.ErrorCodeConstants;
import com.basiclab.iot.infra.enums.job.JobStatusEnum;
...
import static com.basiclab.iot.common.utils.collection.CollectionUtils.containsAny;
...
public class JobServiceImpl implements JobService {
    ...
    private void validateJobHandlerExists(String handlerName) {
        ...
        if (handler == null) {
            throw ServiceExceptionUtil.exception(ErrorCodeConstants.JOB_HANDLER_BEAN_NOT_EXISTS);
        }
        if (!(handler instanceof JobHandler)) {
            throw ServiceExceptionUtil.exception(ErrorCodeConstants.JOB_HANDLER_BEAN_TYPE_ERROR);
        }
    }
