package com.basiclab.iot.infra.service.demo.demo03;
...
import com.basiclab.iot.infra.dal.pgsql.demo.demo03.Demo03CourseMapper;
import com.basiclab.iot.infra.dal.pgsql.demo.demo03.Demo03GradeMapper;
import com.basiclab.iot.infra.dal.pgsql.demo.demo03.Demo03StudentMapper;
...
public class Demo03StudentServiceImpl implements Demo03StudentService {
    ...
    private void validateDemo03StudentExists(Long id) {
        if (demo03StudentMapper.selectById(id) == null) {
            throw ServiceExceptionUtil.exception(ErrorCodeConstants.DEMO03_STUDENT_NOT_EXISTS);
        }
    }
    ...
    public Long createDemo03Grade(Demo03GradeDO demo03Grade) {
        ...
        if (demo03GradeMapper.selectByStudentId(demo03Grade.getStudentId()) != null) {
            throw ServiceExceptionUtil.exception(ErrorCodeConstants.DEMO03_GRADE_EXISTS);
        }
        demo03GradeMapper.insert(demo03Grade);
    ...
    private void validateDemo03GradeExists(Long id) {
        if (demo03GradeMapper.selectById(id) == null) {
            throw ServiceExceptionUtil.exception(ErrorCodeConstants.DEMO03_GRADE_NOT_EXISTS);
        }
    }
