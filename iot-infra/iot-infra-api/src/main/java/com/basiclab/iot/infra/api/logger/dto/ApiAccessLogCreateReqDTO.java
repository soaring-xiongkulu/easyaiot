package com.basiclab.iot.infra.api.logger.dto;
...
public class ApiAccessLogCreateReqDTO {
    ...
    @Schema(description = "应用名", example = "system-server")
    ...
    @Schema(description = "操作模块", example = "商品模块")
    private String operateModule;
    @Schema(description = "操作名", example = "商品新增")
