package com.basiclab.iot.model.framework.security.config;
 ...
 */
@Configuration(proxyBeanMethods = false, value = "modelSecurityConfiguration")
public class SecurityConfiguration {

    @Bean("modelAuthorizeRequestsCustomizer")
