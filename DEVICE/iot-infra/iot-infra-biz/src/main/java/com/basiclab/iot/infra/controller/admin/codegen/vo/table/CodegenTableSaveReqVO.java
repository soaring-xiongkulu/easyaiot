...
public class CodegenTableSaveReqVO {
    ...
    @Schema(description = "生成场景，参见 CodegenSceneEnum 枚举", example = "1")
    ...
    @Schema(description = "业务名", example = "codegen")
    @NotNull(message = "业务名不能为空")
    private String businessName;

    @Schema(description = "类名称", example = "CodegenTable")
    ...
    @Schema(description = "前端类型，参见 CodegenFrontTypeEnum 枚举", example = "20")
