...
import com.basiclab.iot.common.text.CharsetKit;
...
import com.basiclab.iot.tdengine.domain.model.FieldsVO;
...
public class ProductServiceImpl implements ProductService {
    ...
    public AjaxResult productJsonDataAnalysis(JSONObject content, String appId, String templateIdentification, String status) throws Exception {
        try {
            ...
            for (int i = 0; i < services.size(); i++) {
                ...
                productServices.setCreateBy("admin");
                ...
                for (int j = 0; j < properties.size(); j++) {
                    ...
                    productProperties.setCreateBy("admin");
    ...
    public int deleteProductByIds(Long[] ids) {
        List<String> templateIdentifications = productMapper.selectIdentificationByIds(ids);
        //删除属性
        productServicesService.deleteByTemplateIds(templateIdentifications);
        //删除服务
        productPropertiesService.deleteByTemplateIds(templateIdentifications);
    ...
    @Override
    public Product findOneByProductIdentificationAndProtocolType(String productIdentification) {
        return productMapper.findOneByProductIdentificationAndProtocolType(productIdentification);
    }
