...
public class PublishMessageRequestParam implements Serializable {
    ...
    @ApiModelProperty(value = "Tenant ID associated with the message, for multi-tenant environments.", notes = "Unique identifier for the tenant.", name = "tenantId ,default value is iot")
