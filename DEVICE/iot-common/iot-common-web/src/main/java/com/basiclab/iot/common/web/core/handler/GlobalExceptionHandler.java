...
import static com.basiclab.iot.common.exception.GlobalErrorStatus.*;
...
public class GlobalExceptionHandler {
    ...
    public CommonResult<?> serviceExceptionHandler(ControllerException ex) {
        if (!IGNORE_ERROR_MESSAGES.contains(ex.getMsg())) {
