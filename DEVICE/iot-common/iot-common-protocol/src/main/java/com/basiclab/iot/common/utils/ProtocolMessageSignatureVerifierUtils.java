...
//        encryptedMessage.put("dataBody", encryptedDataBody);
    ...
    public static String decryptMessage(String messageJson, String signKey, String encryptKey, String encryptVector) throws Exception {
        ...
        // 获取加密后的报文体和数据签名
        String encryptedDataBody = (String) message.get("dataBody");
...
//        if (CharSequenceUtil.isNotBlank(dataSign) && !verifyDataSign(encryptedDataBody, timeStamp, signKey, dataSign)) {
        if ((Objects.isNull(dataSign) || dataSign.isEmpty())) {
    ...
    public static void main(String[] args) {
        String dataBody = "hahha";
        int cipherFlag = 2;
        String signKey = "111";
        String encryptKey = "9a78fGcD5e2BvN6L";
        String encryptVector = "0";
