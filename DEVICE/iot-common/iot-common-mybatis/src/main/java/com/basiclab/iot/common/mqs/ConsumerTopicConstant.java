...
public interface ConsumerTopicConstant {
    ...
    interface Mqtt {
         ...
         */
        String IOT_MQS_MQTT_MSG = "iot-pro-mqs-mqttMsg";
    ...
    interface Link {
         ...
         * 边缘智能盒子
         */
        String EVENT_SYS_LOG_TOPIC = "event-sys-log-topic";
        String EVENT_STATE_TOPIC = "event-state-topic";
        String EVENT_ALERT_TOPIC = "event-alert-topic";
        String EVENT_ADDRESS_TOPIC = "event-address-topic";
        /**
         * 设备日志上传响应
         */
